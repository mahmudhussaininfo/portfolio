              ...
              <div className="col-md-6 about-content">
                <div className="mamu-about-content">
                  ...
                  <p>
                    ...
                    of experience in the world of web development, My journey
                    began with a fascination for coding during my early years,
                    and that curiosity has led me to become proficient in both
                  ...
                  <div className="mamu-button">
                    <a className="mamuu text-center" href="">
                      HIRE ME
                    </a>
                  </div>
                </div>
